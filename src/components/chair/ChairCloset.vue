                    ...
                    <tbody class="text-default text-center">
                        <tr v-for="data in chairClosetData" :key="data">
                            ...
                            <td class="border border-customWhite px-4 py-2 text-sm">
                                <div class="">
                                    <button
                                        class="inline-flex sm:text-xs md:text-xs w-2/3 items-center justify-center px-4 py-1 bg-header text-highlight text-sm font-medium rounded-md border-2 border-highlight hover:bg-highlight hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                                        :disabled="
                                    ...
                                    <button
                                        class="inline-flex mt-1 sm:text-xs md:text-xs w-2/3 items-center justify-center px-4 py-1 bg-header text-activate text-sm font-medium rounded-md border-2 border-activate hover:bg-activate hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
